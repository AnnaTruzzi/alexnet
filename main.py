...
parser.add_argument('--resume-fallback', default='', type=str, metavar='PATH',
                    help='path to penultimate checkpoint (default: none)')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.resume:
        ...
        try:
            ...
            if args.gpu is None:
                ...
                # Map model to be loaded to specified single gpu.ls
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, args, is_best, filename='checkpoint_%d.pth.tar'%(epoch+1))
