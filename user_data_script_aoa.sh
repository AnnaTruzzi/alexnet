...
if [ $VOLUME_ID ]; then
		...
		# Get training code
		cd /home/ubuntu/
		git clone https://github.com/rhodricusack/alexnet.git
...
echo "All jobs done"
# TODO: Find good way of cleaning up when we're done - probably need to check on SQS and also on currently running jobs
# 
